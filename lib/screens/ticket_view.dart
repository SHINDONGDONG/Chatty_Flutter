                  ...
                  Row(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: Text(
                          "${ticket['from']['name']}",style: Styles.headLineStyle4.copyWith(color: Colors.white),
                        ),
                      ),
                      ...
                      SizedBox(
                        width: AppLayout.getWidth(100),
                        child: Text(
                          "${ticket['to']['name']}",textAlign:TextAlign.end, style: Styles.headLineStyle4.copyWith(color: Colors.white,),
                        ),
                      ),
                    ],
                  ),
