                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: const Icon(FluentSystemIcons.ic_fluent_lock_shield_filled,
                ...
                children: [
                  InkWell(
                    ...
                    child: Text("Edit",style:
                      Styles.textStyle.copyWith(color: Styles.primaryColor,fontWeight: FontWeight.w300),),
                  ),
                ],
              ),
            ],
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Gap(AppLayout.getHeight(12),),
                AppLayoutBuilderWdiget(section: 12,isColor: false,),
                Gap(AppLayout.getHeight(12),),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children:const [
